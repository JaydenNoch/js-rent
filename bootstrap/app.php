...
// Kita pakai class anonim yang extends langsung dari namespace core Laravel
...
// Paksa storage Laravel pindah ke /tmp milik Vercel agar bisa nulis session & cache
if (isset($_SERVER['VERCEL_URL']) || env('VERCEL_URL')) {
